...
const DashboardPage: FC = () => {
	...
	const lineOptions = {
		...
		series: [
			...
			{ name: "Pedidos", type: "line", smooth: true, data: [920, 1230, 940, 1450, 960, 1270, 865, 1480, 1995] },
	...
	return (
		<div className="p-4 md:p-6 space-y-4">
			...
			<Row gutter={[16, 16]}>
				...
				<Col xs={24} sm={12} md={6}>
					<Card bordered title={<div className="text-gray-500 text-sm flex items-center gap-2"><AppstoreOutlined /> Pedidos</div>}>
						<div className="flex w-full items-center justify-between">
