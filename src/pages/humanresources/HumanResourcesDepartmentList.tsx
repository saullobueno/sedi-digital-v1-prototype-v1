...
import { data, DataType, columns } from "../../data/humanresources/humanresourcesdepartment";
...
const HumanResourcesDepartmentList: React.FC = () => {
	...
	return (
		<>
			<Breadcrumb
				items={[{ title: 'Inicio' }, { title: 'Recursos Humanos' }, { title: 'Departamento Pessoal' }]}
			...
			<Drawer
				title={selected ? `Editar cliente: ${selected.employeeId}` : "Editar cliente"}
				placement="right"
				width={520}
				open={drawerOpen}
...
export default HumanResourcesDepartmentList;