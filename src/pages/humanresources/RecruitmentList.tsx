...
import { data, DataType, columns } from "../../data/humanresources/recruitment";
...
const RecruitmentList: React.FC = () => {
	...
	return (
		<>
			<Breadcrumb
				items={[{ title: 'Inicio' }, { title: 'Recursos Humanos' }, { title: 'Recrutamento' }]}
			...
			<Drawer
				title={selected ? `Editar cliente: ${selected.candidate}` : "Editar cliente"}
				placement="right"
				width={520}
				open={drawerOpen}
