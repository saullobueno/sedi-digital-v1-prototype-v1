...
import { data, DataType, columns } from "../../data/thirdparties/suppliers";
...
const SuppliersList: React.FC = () => {
	...
	return (
		<>
			<Breadcrumb
				items={[{ title: 'Inicio' }, { title: 'Terceiros' }, { title: 'Fornecedores' }]}
			...
			<Drawer
				title={selected ? `Editar cliente: ${selected.supplier}` : "Editar cliente"}
				placement="right"
				width={520}
				open={drawerOpen}
