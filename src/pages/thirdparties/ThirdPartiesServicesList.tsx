...
import { data, DataType, columns } from "../../data/thirdparties/thirdpartiesservices";
...
const ThirdPartiesServicesList: React.FC = () => {
	...
	return (
		<>
			<Breadcrumb
				items={[{ title: 'Inicio' }, { title: 'Terceiros' }, { title: 'Serviços' }]}
			...
			<Drawer
				title={selected ? `Editar cliente: ${selected.contractId}` : "Editar cliente"}
				placement="right"
				width={520}
				open={drawerOpen}
...
export default ThirdPartiesServicesList;