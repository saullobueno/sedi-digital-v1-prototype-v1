	...
	return (
		<>
			...
			<Drawer
				...
				extra={
					<Space>
						<Button color="default" variant="text" icon={<SaveOutlined />} onClick={salvar}>
							Salvar
						</Button>
					</Space>
				}
							...
							// ===== RESUMO =====
							{
								...
								children: (
									<>
										...
										<Descriptions column={2} size="small" className="my-10">
											<Descriptions.Item label="Nº OS">
											...
											<Descriptions.Item label="CNPJ faturamento">
												{form.getFieldValue("billingCnpj") || "—"}
											</Descriptions.Item>
											<Descriptions.Item label="Condição de pagamento">
												{form.getFieldValue(["billing", "condicaoPagamento"]) || "—"}
											</Descriptions.Item>
							...
							// ===== OS (FSP + PROPOSTA unificadas) =====
							{
								...
								children: (
									<>
										...
										<Row gutter={gutter}>
											<Col span={colSpan}>
												<Form.Item name="status" label="Status" valuePropName="checked">
													<Select defaultValue='Não iniciada' options={[{ label: 'Não iniciada', value: 'Não iniciada' }]} />
												</Form.Item>
											</Col>
											<Col span={colSpan}>
												<Form.Item name="situation" label="Situação" valuePropName="checked">
													<Select defaultValue='Criada' options={[{ label: 'Criada', value: 'Criada' }]} />
												</Form.Item>
											</Col>
										</Row>
										...
										<Row gutter={gutter}>
											<Col span={colSpan}>
												<Form.Item name="numeroOS" label="Número OS" initialValue={selected?.numeroFSP} rules={[{ required: true }]}>
													{selected?.numeroFSP}
												</Form.Item>
											</Col>
											<Col span={colSpan}>
												<Form.Item name="sediUnit" label="Unidade / Filial">
										...
										<div className="mt-6">
											...
											<Typography.Title level={5} className="mb-6">Solicitante</Typography.Title>
										...
										<div className="mt-6">
											<Typography.Title level={5}>Serviços e processos</Typography.Title>
														...
														{serviceFields.map((serviceField, index) => (
															...
															>
																<Row gutter={gutter}>
																	...
																	<Col span={colSpan}>
																		<Form.Item
																			name={[serviceField.name, "metragemM2"]}
																			label="Metragem (em m²)"
																		>
																...
																{/* PROCESSOS DO SERVIÇO COM VALOR (FSP + PROPOSTA) */}
																				...
																				{processFields.map((processField, pIndex) => (
																					<Col span={24} className="mt-2" key={processField.key}>
																						<Row gutter={gutter} className="mt-2">
																							...
																							<Col span={2} className="flex items-end justify-center pb-1">
																								<Button
																									danger
																									type="text"
																									icon={<DeleteOutlined />}
																									onClick={() => removeProcess(processField.name)}
																								/>
																							</Col>
																							<Col span={24}>
																								<Divider />
										...
										<div className="mt-6">
											<Typography.Title level={5}>Avaliação e detalhes</Typography.Title>

											<Row gutter={gutter}>
												<Col span={colSpan}>
													<Form.Item name="grauDificuldade" label="Dificuldade">
												...
												<Col span={colSpan}>
													<Form.Item name="impactoSeNaoResolver" label="Impacto">
														<Input placeholder='Impacto se não resolver' />
													</Form.Item>
												</Col>
												<Col span={colSpan}>
													<Form.Item name="alternativaSedi" label="Concorrência">
														<Input placeholder='Alternativa à SÉDI (Concorrência)' />
													</Form.Item>
												</Col>

												<Col span={colSpan}>
													<Form.Item name="capacidadeFinanceira" label="Capacidade Financeira">
												...
												<Col span={colSpan}>
													<Form.Item name="previsaoGastosViagem" label="Gastos com viagem">
														<Input placeholder='Gastos com viagem' />
													</Form.Item>
												</Col>

												<Col span={colSpan}>
													<Form.Item name="gastosTerceiros" label="Gastos com terceiros">
												...
												<Col span={colSpan}>
													<Form.Item name="sugestaoHonorarios" label="Honorários">
														<Input placeholder='Sugestão de honorários' />
													</Form.Item>
												</Col>

												<Col span={colSpan}>
													<Form.Item name="montagemProcesso" label="Montagem">
														<Input placeholder='Montagem do processo' />
													</Form.Item>
												</Col>
												<Col span={colSpan}>
													<Form.Item name="acompanhamento" label="Acompanhamento">
														<Input placeholder='' />
													</Form.Item>
												</Col>
												<Col span={colSpan}>
													<Form.Item name="permanenciaOrgao" label="Permanência no órgão">
												...
												<Col span={24}>
													<Form.Item name="visitaInLoco" label="Visita">
														<Input.TextArea rows={4} placeholder='Visita em loco' />
													</Form.Item>
												</Col>
												<Col span={24}>
													<Form.Item
													...
													>
														<Input.TextArea rows={4} placeholder='Outras atividades não mencionadas' />
													</Form.Item>
												</Col>
											</Row>
										</div>
								...
								children: (
									<>
										...
										<Row gutter={gutter}>
											...
											<Col span={colSpan}>
												<Form.Item name={["billing", "valorTotal"]} label="Valor Total">
													<InputNumber
														className="w-full"
														placeholder="0,00"
														formatter={(value: any) =>
											...
											<Col span={colSpan}>
												<Form.Item name="responsavel" label="Responsável comercial">
													<Input />
												</Form.Item>
											</Col>
										...
										<Row gutter={gutter} className="h-full">
												...
												<Row gutter={gutter}>
													<Col span={24}>
														<Form.Item
															...
															rules={[
																{ required: true, message: "Selecione pelo menos um arquivo" },
															]}
														>
															<Upload.Dragger
																multiple
															...
															>
																...
																<p className="ant-upload-hint">
																	Envie documentos como alvará de funcionamento, licença sanitária,
																	AVCB, etc.
																</p>
															</Upload.Dragger>
														</Form.Item>
												...
												<Row gutter={gutter}>
													<Col span={24}>
														<Form.Item
															...
															label="Nome"
															rules={[{ required: true, message: "Informe o nome do documento" }]}
														>
													...
													<Col span={12}>
														<Form.Item
															...
															rules={[{ required: true, message: "Informe a data de emissão" }]}
														>
															<DatePicker placeholder="YYYY-MM-DD" className="w-full" />
														</Form.Item>
													</Col>
													...
													<Button
														...
														onClick={() => {
															...
															if (!newDoc?.nome || !newDoc?.files?.length) {
																message.error("Preencha o nome e selecione pelo menos um arquivo.");
																return;
															}
															...
															form.setFieldsValue({
																...
																newDocument: {}, // limpa o form temporário
															});
											...
											<Col span={12}>
												...
												<Card
													...
													bordered={false}
													bodyStyle={{
														maxHeight: "calc(100vh - 260px)", // ajusta conforme header/footer da página
														overflowY: "auto",
														paddingRight: 8,
													}}
												>
																		...
																		<List.Item
																			actions={[
																				<Button
																					...
																					onClick={() => {
																						...
																						form.setFieldsValue({
																							editDocument: {
																								...item,
																								// se estiver usando moment no DatePicker, converta aqui
																								// dataEmissao: item.dataEmissao ? dayjs(item.dataEmissao) : null,
																								// dataValidade: item.dataValidade ? dayjs(item.dataValidade) : null,
																							},
																						});
																				...
																				<Popconfirm
																					...
																					cancelText="Não"
																					onConfirm={() => {
																						const currentDocs: any[] = form.getFieldValue("documents") || [];
																		...
																		>
																			<Space direction="vertical" size={0} className="w-full">
																				...
																				<Typography.Text type="secondary">
																					...
																					{item.dataEmissao
																						? item.dataEmissao?.format
																							? item.dataEmissao.format("YYYY-MM-DD")
																							: item.dataEmissao
																						: "—"}
																					{item.dataValidade && " • Validade: "}
																					{item.dataValidade
																						? item.dataValidade?.format
																							? item.dataValidade.format("YYYY-MM-DD")
																							: item.dataValidade
																						: ""}
																				</Typography.Text>
																				...
																				{item.arquivos?.length > 0 && (
																					<Typography.Text type="secondary">
																						Arquivo(s): {item.arquivos.join(", ")}
																					</Typography.Text>
																				)}

																				{item.observacao && (
																					<Typography.Text>{item.observacao}</Typography.Text>
																				)}
																			</Space>
																		</List.Item>
																	)}
