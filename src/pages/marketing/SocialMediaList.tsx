...
import { data, DataType, columns } from "../../data/marketing/socialmedia";
...
const SocialMediaList: React.FC = () => {
	...
	return (
		<>
			<Breadcrumb
				items={[{ title: 'Inicio' }, { title: 'Marketing' }, { title: 'Redes Sociais' }]}
			...
			<Drawer
				title={selected ? `Editar cliente: ${selected.campaign}` : "Editar cliente"}
				placement="right"
				width={520}
				open={drawerOpen}
