...
import { data, DataType, columns } from "../../data/finance/payable";
...
const PayableList: React.FC = () => {
	...
	return (
		<>
			<Breadcrumb
				items={[{ title: 'Inicio' }, { title: 'Financeiro' }, { title: 'Contas a Pagar' }]}
			...
			<Drawer
				title={selected ? `Editar cliente: ${selected.billNumber}` : "Editar cliente"}
				placement="right"
				width={520}
				open={drawerOpen}
